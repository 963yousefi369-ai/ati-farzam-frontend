          ...
          {recent.map((entry, i) => {
            ...
            return (
              ...
              >
                ...
                <BreadcrumbItem>
                  {isLast ? (
                    <BreadcrumbPage className="flex items-center gap-1 text-[11px] text-white/80 font-medium px-2 py-1 rounded-lg bg-white/[0.06]">
                    ...
                    <BreadcrumbLink
                      asChild
                      className="flex items-center gap-1 text-[11px] text-white/60 hover:text-white/90 px-2 py-1 rounded-lg hover:bg-white/[0.04] transition-all duration-200"
                    >
