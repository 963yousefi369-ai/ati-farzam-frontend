...
const badgeVariants = cva(
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-moderate',
  {
    variants: {
      variant: {
        ...
        gradient:    'border-transparent bg-gradient-to-l from-navy to-teal text-white shadow-sm',
      },
    },
