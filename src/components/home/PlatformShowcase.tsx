    ...
    <section className="overflow-hidden rounded-3xl bg-dark text-white">
      <div className="grid items-center gap-10 p-6 sm:p-8 lg:grid-cols-[minmax(0,.85fr)_minmax(420px,1.15fr)] lg:gap-14 lg:p-12">
        <div>
          ...
          <Link
            href="/software"
            className="mt-8 inline-flex min-h-12 items-center gap-2 rounded-xl bg-accent px-6 text-sm font-semibold text-dark transition-colors hover:bg-accent-light"
          >
            {platform.cta}
        ...
        <div className="relative aspect-[4/3] overflow-hidden rounded-2xl border border-white/10 bg-dark-deeper">
          {softwareImage ? (
            <Image
              ...
              alt="نمای پلتفرم ردیابی آتی فرزام"
              fill
            ...
            <div className="flex h-full items-center justify-center p-4">
              <DashboardMockup className="h-auto w-full" />
            </div>
          )}
        </div>
      </div>
