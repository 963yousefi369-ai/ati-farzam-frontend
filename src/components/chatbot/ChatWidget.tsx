  ...
  return (
    <>
      <Dialog.Root open={isOpen} onOpenChange={setIsOpen}>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content
            className="fixed flex flex-col outline-none
              top-[80px] bottom-[84px] right-3 left-3 rounded-2xl
          ...
          >
            ...
            >
              <div className="relative">
                <div className="w-10 h-10 rounded-full bg-white/15 flex items-center justify-center">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                    ...
                    <path d="M9 16.5C9 16.5 10.5 18 12 18C13.5 18 15 16.5 15 16.5" stroke="#0e7490" strokeWidth="1.5" strokeLinecap="round"/>
                    ...
                    <circle cx="8" cy="2.5" r="1.5" fill="#0e7490"/>
                    <circle cx="16" cy="2.5" r="1.5" fill="#b45309"/>
                  </svg>
                </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className={`text-xs mt-0.5 ${isOnline ? 'text-emerald-300' : 'text-text-muted'}`}>
              ...
              <div className="absolute bottom-0 left-0 right-0 h-[2px]"
                style={{ background: 'linear-gradient(90deg, #0e7490, #155e6f, #b45309)' }}
              />
            </div>
                ...
                >
                  ...
                  <div
                    className={`max-w-[85%] px-3 sm:px-4 py-2.5 sm:py-3 text-[14px] sm:text-[13px] leading-relaxed ${
                      msg.role === 'user'
                        ...
                        : 'rounded-2xl rounded-tr-md text-text-heading'
                    }`}
                    style={
                      msg.role === 'user'
                        ? { background: 'linear-gradient(135deg, #155e6f, #0e7490)' }
                  ...
                  {msg.role === 'user' && (
                    <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full shrink-0 mt-0.5 flex items-center justify-center"
                      style={{ background: 'linear-gradient(135deg, #0e7490, #155e6f)' }}>
            ...
            <AnimatePresence>
              {showScrollBtn && (
                <motion.button
                  ...
                  className="absolute bottom-[60px] sm:bottom-[76px] left-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-white shadow-lg border border-border-soft flex items-center justify-center z-10"
                >
            ...
            >
              <input
                ...
                className="flex-1 min-w-0 px-4 py-2.5 rounded-xl bg-white outline-none transition-all duration-200 placeholder:text-text-muted disabled:opacity-50"
                style={{
                  fontSize: '16px',
              ...
              <motion.button
                ...
                style={{ background: 'linear-gradient(135deg, #155e6f, #0e7490)' }}
              >
                {isLoading ? (
        ...
        {/* Toggle Button */}
        <div className={`fixed bottom-4 right-4 sm:bottom-6 sm:right-6 ${isOpen ? 'hidden sm:block' : ''}`} style={{ zIndex: 310, paddingBottom: 'env(safe-area-inset-bottom, 0px)' }} dir="rtl">
          <div className="relative">
            {!isOpen && (
              <>
                ...
                <span className="absolute -inset-1 rounded-full"
                  style={{ background: 'linear-gradient(135deg, #0e7490, #155e6f)', opacity: 0.15, animation: 'breathe 2s ease-in-out infinite' }} />
              </>
            )}
